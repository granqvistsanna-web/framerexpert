---
slug: anlita-framer-expert-kostnad
page_id: post30
category: tips
date: 2026-08-12
...
Du betalar för nedlagd tid och får en löpande avräkning. Fördelen är flexibilitet: ändrar du dig halvvägs behöver ingen omförhandla avtalet. Nackdelen är att du bär risken för att arbetet drar ut, och att budgeten är svår att sätta i förväg.

Timpris fungerar bäst när omfattningen är genuint oklar, när du vill styra prioriteringarna löpande, eller när uppdraget är litet och avgränsat — någon som fixar tre sektioner och en formulärkoppling.
...
Fastpris kräver att någon har gjort tankearbetet i förväg: hur många sidor, vilka sektioner, vilket innehåll, hur många revideringsrundor. Ett fastpris utan den specificeringen är inte trygghet, det är en framtida konflikt.
...
Priset på ett Framer-projekt är sällan "designtid". Det är summan av ett antal moment som alla tar tid, och som olika leverantörer inkluderar olika mycket av:

- **Strategi och struktur** — vad sajten ska åstadkomma, vilka sidor som behövs, vad besökaren ska göra
- **Copy** — texten på sajten. Den absolut vanligaste källan till försening, och ofta oklart vem som äger den
- **Design** — själva formgivningen, inklusive responsiva brytpunkter
- **Bygge i Framer** — implementationen, komponenter, återanvändbara sektioner
- **CMS-struktur** — samlingar, fält och detaljsidor om sajten har blogg, case eller produkter
- **Animationer och interaktioner** — allt från enkla hover-effekter till scroll-driven rörelse
- **Teknisk grund** — prestanda, [Core Web Vitals](/blog/framer-core-web-vitals.html), metadata, sitemap, [strukturerad data](/blog/framer-strukturerad-data.html)
...
**Antal sidor och unika sektioner.** Fem sidor som återanvänder samma tolv sektioner är ett litet projekt. Fem sidor som alla ser olika ut är ett stort. Det är antalet unika designbeslut som kostar, inte sidräkningen.

**Vem skriver texten.** Om du levererar färdig, beslutad copy kan bygget gå fort. Om leverantören ska skriva den — eller värre, vänta på den — påverkar det både pris och tidplan.

**CMS eller statiskt.** Ska innehållet kunna uppdateras utan designerhjälp behövs en genomtänkt CMS-struktur. Det är arbete som inte syns i designen men som avgör om sajten håller i två år.

**Animationsambition.** Enkla hover- och scroll-effekter ingår normalt. Scroll-driven storytelling eller specialbyggda [interaktioner](/blog/framer-animationer-interactions.html) är en egen post — det kan vara värt varje krona, men det är sällan gratis.
...
Två offerter är jämförbara först när de svarar på samma frågor. Skicka samma underlag till alla du frågar, och begär att offerten specificerar:

- **Antal sidor och antal unika sektioner** som ingår
- **Vem som levererar copy och bilder**
- **Om CMS ingår** och i så fall hur många samlingar
- **Antal revideringsrundor** innan tillägg börjar debiteras
- **Vad som händer vid scope-ändring** och till vilket timpris
- **Vem som äger Framer-projektet** efter leverans
- **Vad överlämningen innehåller** — dokumentation, genomgång, behörigheter
- **Tidplan med milstolpar**, inte bara ett slutdatum

Den offert som är dubbelt så dyr är ibland den billigare — om den innehåller copy, migrering och tre revideringsrundor medan den lägre bara innehåller bygget.
...
**Ingen som frågar om målet.** Om ingen frågar vad sajten ska åstadkomma får du något som ser bra ut i portföljen och presterar medelmåttigt i verkligheten.

**Oklart ägande.** Ligger projektet kvar på leverantörens Framer-konto efter leverans är du beroende av dem för varje framtida ändring. Det ska stå i avtalet vem som äger vad.

**Prestanda och SEO som tillägg.** Grundläggande metadata, rimliga bildstorlekar och en fungerande sitemap är inte en uppgradering. Det är hantverk.

## Så sänker du kostnaden utan att sänka kvaliteten

**Kom med beslutad copy.** Det enskilt mest effektiva du kan göra. Text som är färdig och godkänd tar bort den vanligaste förseningen.

**Börja från en mall.** En genomarbetad [Framer-template](/blog/framer-templates-guide.html) kan korta bygget avsevärt — men bara om den passar innehållet. Vi har gått igenom [när mall slår eget bygge](/blog/framer-mall-eller-bygga-sjalv.html) och hur du [utvärderar en template](/blog/utvardera-framer-template.html) innan köp.

**Skär i antalet unika sektioner, inte i sidorna.** Färre designmönster som återanvänds ger en mer sammanhållen sajt *och* ett billigare bygge.

**Fasindela.** Lansera det som ger effekt först, lägg CMS-bloggen eller det andra språket i etapp två. Du får en sajt live tidigare och kan prioritera med riktiga besöksdata.

**Samla feedback.** Tre personer som skickar spridda kommentarer i två veckor kostar mer än ett samlat svar från en beslutsfattare.
