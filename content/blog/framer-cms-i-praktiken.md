...
Stub entry. The live HTML lives at `blog/framer-cms-i-praktiken.html` and
predates the build script. This file exists so other posts can reference
this slug via `related:`.
